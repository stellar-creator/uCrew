<?php
	...
	$pager = $uc_Projects->getPager($page, $count, 'ucp_cables', '/?page=uCrewProjects/cables');
?>
<div class="row">
		...
		foreach ($list as $item => $values) {
			...
			echo '
				<tr>
					...
					<td class="align-middle text-center"><a href="/?page=uCrewProjects/cablesItem&id='.$values['cable_id'].'" class="link-dark" style="text-decoration:none">'.$values['cable_codename'].'</a></td>
